...
/*
	...
	LM: Consider supporting pop-up instead of drop-down depending on component position on stage.
	LM: Consider adding prompt functionality (default, non-selectable first item)
*/
...
// Public Methods:
	 ...
	 */
	public function get itemRenderer():Object { return _dropdown.itemRenderer; }
	 ...
	 */
	public function get scrollBar():Object { return _dropdown.scrollBar; }
	...
	public function get dropdownWidth():Number { return _dropdownWidth; }
	...
	public function set rowCount(value:Number):Void {
		...
		// LM: If we support pop-up instead of dropdown, we may have to call movePopUp() to reposition it.
	}
	...
	public function set selectedIndex(value:Number):Void {
		...
		if (_dropdown != null) { _dropdown.selectedIndex = value; }
		updateSelectedItem();
	}
	...
	public function set labelField(value:String):Void {
		_labelField = value;
		if (_dropdown != null) { _dropdown.labelField = _labelField; }
		updateLabel();
	}
	...
	public function set labelFunction(value:Function):Void {
		...
		if (_dropdown != null) { _dropdown.labelFunction = _labelFunction; }
		updateLabel();
	}
	...
	public function removeMovieClip():Void {	
		if (_dropdown) { _dropdown.removeMovieClip(); }
...
// Private Methods:
	private function createDropDown():Void {
		if (_dropdown == inspectableDropdown) { return; }
		if (_dropdown != null) {
		...
		if (_dropdown.wrapping != null) { _dropdown.wrapping = "stick"; }		
	...
	private function changeFocus():Void {
		super.changeFocus();
		if (isOpen && _dropdown != null) { close(); }
	}
