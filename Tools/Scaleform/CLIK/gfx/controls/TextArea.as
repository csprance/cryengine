...
// Private Methods:
	...
	private function updateTextField():Void {
		...
		if (textField != null) {
			if (_scrollBar != null) { _scrollBar.scrollTarget = textField; }
		}		
	}
	...
	private function updateScrollBar():Void {
		maxscroll = textField.maxscroll;
		if (_scrollBar == undefined) { return; }
		...
		if (_scrollBar.disabled != _disabled) {  _scrollBar.disabled = _disabled; }
	}
	...
	private function onScroller():Void {
		if (resetScrollPosition) { textField.scroll = _position; }
		else { _position = textField.scroll; }
