...
// Public Methods:
	...
	public function set selected(value:Boolean):Void {        
        ...
        if (value && owner) {
            ...
            if (!bDisplayFocus) { ownerFocusTarget = owner.focusTarget; } // if the owner wasn't focused, check whether it had a focus target (eg. scrolling list for drop down menu).
            if (ownerFocusTarget && ownerFocusTarget.focused) { bDisplayFocus = true; }
        }
