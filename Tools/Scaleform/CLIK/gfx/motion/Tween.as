...
// Constants:
	...
	public static function linearEase(t:Number,b:Number,c:Number,d:Number):Number { return c * t / d + b; }
...
// Private Methods
	...
	private function tween__run():Void {
		...
		if (pos >= 1) {
			tweenEnd(true);
			if (this["onTweenComplete"]) { this["onTweenComplete"](); }
		}
		else { tween__to(tween__ease(pos,0,1,1)); } // GDS: tween function
	}
